...
--
-- Table structure for table `bis_pub_system`
--

DROP TABLE IF EXISTS `bis_pub_system`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bis_pub_system` (
...
--
-- Dumping data for table `bis_pub_system`
--

LOCK TABLES `bis_pub_system` WRITE;
/*!40000 ALTER TABLE `bis_pub_system` DISABLE KEYS */;
INSERT INTO `bis_pub_system` VALUES (1,'SYS_MATCH','MATCH system',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `bis_pub_system` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-12-06 17:26:38
